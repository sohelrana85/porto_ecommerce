        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="home-slider owl-carousel owl-theme owl-carousel-lazy mb-2" data-owl-options="{
                    ...
                    <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw">
                        ...
                        <div class="banner-layer banner-layer-middle">
                            ...
                            <h5 class="text-white text-uppercase d-inline-block mb-0 ls-n-20 align-text-bottom">Starting At
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            ...
                            <div class="product-details">
                                ...
                                <h2 class="product-title">
                                    <a href="{{ route('product', $featureproduct->slug) }}"
                                        style="font-size: 14px;">{{ $featureproduct->name }}</a>
                                </h2>
                ...
                {{-- <div class="brands-slider owl-carousel owl-theme images-center mb-3" data-owl-options="{
                    ...
                    <img src="{{ asset('frontend/assets/images/brands/brand1.png') }}" width="140" height="60"
                        alt="brand">
                    <img src="{{ asset('frontend/assets/images/brands/brand2.png') }}" width="140" height="60"
                        alt="brand">
                    <img src="{{ asset('frontend/assets/images/brands/brand3.png') }}" width="140" height="60"
                        alt="brand">
                    <img src="{{ asset('frontend/assets/images/brands/brand4.png') }}" width="140" height="60"
                        alt="brand">
                    <img src="{{ asset('frontend/assets/images/brands/brand5.png') }}" width="140" height="60"
                        alt="brand">
                    <img src="{{ asset('frontend/assets/images/brands/brand6.png') }}" width="140" height="60"
                        alt="brand">
