                    ...
                    <table class="table table-cart">
                        ...
                        <tbody>
                            ...
                            <tr class="product-row">
                                <td class="product-col">
                                    <figure class="product-image-container" >
                                        <a href="{{ route('product', $item->attributes->slug) }}" class="product-image">
                                            <img src="{{ asset('product_photo/'. $item->attributes->thumbnail) }}" alt="product" style="height: 120px">
                                        </a>
                                    </figure>
                                ...
                                <td>&#2547; {{ $item->price }}</td>
                                <td>
                                    <form action="{{ route('cart.update', $item->id) }}" method="post" id="item-{{$item->id}}" class="my-auto">
                                        @csrf
                                        <input class="vertical-quantity form-control" type="text" value="{{$item->quantity}}" name="quantity">
                                    </form>
                                </td>
