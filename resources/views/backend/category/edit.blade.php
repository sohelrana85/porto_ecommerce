                    ...
                    <form action="{{ route('staff.brand.update', $brand->id) }}" method="POST">
                            ...
                            <div class="col-sm-5">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="active" value="active" name="status"
                                        class="custom-control-input" {{ $brand->status == 'Active' ?
                                        'checked':'' }}>
                                    <label class="custom-control-label" for="active">Active</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="inactive" value="inactive" name="status"
                                        class="custom-control-input" {{ $brand->status == 'Inactive' ?
                                    'checked':'' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 text-right">
                                <button type="submit" value="submit" class="btn btn-primary px-4">Update Brand</button>
                            </div>
                        </div>
                    </form>
                </div>
